                          ...
                          <TableRow key={b.id} className={idx % 2 === 0 ? 'bg-background' : 'bg-muted/20'}>
                            ...
                            <TableCell className="py-1 px-2 text-[11px]">
                              <div className="grid grid-cols-2 gap-x-4 gap-y-0 min-w-[140px]">
                                <div className="font-semibold whitespace-nowrap">Bed: {formatCurrency((b.total_price - (b.food_amount || 0)))}</div>
                                <div className="text-[10px] text-muted-foreground whitespace-nowrap">Deposit: {(b.security_deposit || 0) > 0 ? formatCurrency(b.security_deposit || 0) : '-'}</div>
                                {(b.food_amount || 0) > 0 && <div className="text-[10px] text-orange-600 whitespace-nowrap">Food: {formatCurrency(b.food_amount || 0)}</div>}
